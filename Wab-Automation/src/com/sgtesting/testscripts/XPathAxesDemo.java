...
public class XPathAxesDemo {
	...
	static void navigate()
	{
		try
		{
			oBrowser.get("file:///C:/Users/ADMIN/Downloads/xpathaxes_27th_oct_2021/XPathAxes_27th_OCT_2021/WebTableHTML.html");
			Thread.sleep(4000);
		}catch(Exception e)
		{
			e.printStackTrace();		
	...
	{
		oBrowser.findElement(By.xpath("//td[text()='Narendra Modi']/following::tr[1]/td[6]/input")).sendKeys("15000");
	}
