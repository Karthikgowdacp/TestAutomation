...
public class EndtoEndLastadv11 {
	 ...
	 public static WebDriver obrowser=null;
		...
		static void createUser()
		{
			...
			{                      				
				...
				Thread.sleep(2000);
				obrowser.findElement(By.id("userDataLightBox_firstNameField")).sendKeys("karthik");
				Thread.sleep(2000);
				obrowser.findElement(By.id("userDataLightBox_lastNameField")).sendKeys("gowda");
				Thread.sleep(2000);
