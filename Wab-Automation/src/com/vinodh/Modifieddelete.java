...
public class Modifieddelete {
	...
	static void modified()
	{
		try
		{
			...
			oBrowser.findElement(By.id("userDataLightBox_firstNameField")).sendKeys("aaaaa");
			oBrowser.findElement(By.id("userDataLightBox_lastNameField")).clear();
			oBrowser.findElement(By.id("userDataLightBox_lastNameField")).sendKeys("User5");
			oBrowser.findElement(By.id("userDataLightBox_emailField")).clear();
			oBrowser.findElement(By.id("userDataLightBox_emailField")).sendKeys("demoja@gmail.com");
